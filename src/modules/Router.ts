...
const routes = [
    ...
    { path: '/user/:name/shop-cart', name: "Shop cart" , component: ShopCartVue, meta: { transition: 'slide-left' }, },
    { path: '/user/:name/profile', name: "Profile" , component: UserProfileVue, meta: { transition: 'slide-left' }, },
